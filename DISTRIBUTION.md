...
| ClawHub | Registry publish | **Published/latest:** https://clawhub.ai/wuaishare/boyue — `0.2.3`, MIT-0, 13-file curated bundle (`SKILL.md` + references + templates). The accidental broad `0.1.0` version has been withdrawn |
